        ...
        <div class="sidebar-content main-menu-content">
            <div class="nav-container">
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class=" nav-item"><a href=""><i class="fa fa-list-ul"></i><span class="menu-title" data-i18n="Email"> المواد </span></a>
                    <li class=" nav-item"><a href=""><i class="fa fa-list-ul"></i><span class="menu-title" data-i18n="Email"> الأسئلة الشائعة </span></a>
                    <li class=" nav-item"><a href=""><i class="fa fa-list-ul"></i><span class="menu-title" data-i18n="Email"> الإشعارات </span></a>
                    <li class=" nav-item"><a href=""><i class="fa fa-list-ul"></i><span class="menu-title" data-i18n="Email"> الشكاوي </span></a>



                    <li class="has-sub nav-item"><a href="javascript:;"><i class="ft-aperture"></i><span class="menu-title" data-i18n="UI Kit">  الطلاب </span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1"></span></a>
                        <ul class="menu-content">
                            <li><a href="{{url('students')}}"><i class="fa fa-arrow-right submenu-icon"></i><span class="menu-item" data-i18n="Grid"> استيراد بيانات الطلاب   </span> <span class="tag badge badge-pill badge-danger float-right mr-1 mt-1"></span></a>
                            </li>
                            <li><a href="{{url('marks')}}"><i class="fa fa-arrow-right submenu-icon"></i><span class="menu-item" data-i18n="Typography">استيراد العلامات </span>  </a>

                        </ul>
                    </li>

                    <li class=" nav-item"><a href=""><i class="ft-aperture"></i><span class="menu-title" data-i18n="UI Kit">   المحاضرات</span> </a>
